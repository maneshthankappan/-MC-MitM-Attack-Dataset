...
<span style="color: red;">Note: During constant jamming, we target the AP with the MAC address "c0:4a:00:33:3b:62," which operates on channel 1. Refer to the filter used in Wireshark shown in the image below.</span>
<p align="center">
