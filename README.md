...
In MC-MitM base variant attacks, the legitimate channel is 1 since the AP operates on channel while the rogue channel is 13. The dataset or PCAP files can be [downloaded here] 
(https://drive.google.com/drive/folders/1nsOLzfiosLP9e9lcIs7AVPWij9BBNs1C?usp=share_link). These PCAP files can also be viewed online at Cloudshark also. The following is a description of the dataset or PCAP file.
