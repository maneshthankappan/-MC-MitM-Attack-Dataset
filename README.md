...
In MC-MitM base variant attacks, the legitimate channel is 1 since the AP operates on channel while the rogue channel is 13. The dataset or PCAP files can be [downloaded here](https://www.cloudshark.org/captures/2799fd9a88d6](https://drive.google.com/drive/folders/1nsOLzfiosLP9e9lcIs7AVPWij9BBNs1C?usp=share_link). These PCAP files can also be viewed online at Cloudshark also. The following is a description of the dataset or PCAP file.
